export const zh: Record<string, string> = {
  ...
  'Restart': '重新启动',
  'Evaluator Jobs': '评估任务',
  'Evaluator unavailable': '评估器不可用',
  'No evaluator jobs yet.': '还没有评估任务。',
  'No failure reason recorded': '未记录失败原因',
  'Failed to load evaluation job history': '加载评估任务历史失败',
  'Failed to update evaluator': '更新评估器失败',
  'Job already started; evaluator was not changed': '任务已经开始，评估器未更改',
  'Global default': '全局默认',
  'Used for future automatic evaluator jobs.': '用于未来的自动评估任务。',
  'Loading...': '加载中...',
  'Manual': '手动',
  'Heuristic': '启发式',
  'LLM': 'LLM',
  ...
  'Multiplier:': '倍率：',
  'Search models...': '搜索模型...',
  'No models match your search.': '没有匹配搜索的模型。',
  'No pricing data available.': '暂无定价数据。',
  'Cache Read': '缓存读取',
  'Cache Write': '缓存写入',
  'Save Pricing': '保存定价',
  'Effective:': '实际:',
